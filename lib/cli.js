...
const PRODUCT_URL = "https://www.domainwatchdog.app";

const HELP = `domain-watchdog-check — free domain expiry checker (RDAP, the modern WHOIS)

USAGE
  domain-watchdog-check <domain> [more-domains...]
  npx domain-watchdog-check google.com cloudflare.net
...
EXAMPLES
  domain-watchdog-check google.com
  domain-watchdog-check google.com stripe.com example.org
  domain-watchdog-check --json mydomain.com
